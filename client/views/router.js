...
Router.map(function () {
	...
	this.route("slides", {path: "/slides", controller: "SlidesController"});
	this.route("slides.insert", {path: "/slides/insert", controller: "SlidesInsertController"});
	this.route("slides.details", {path: "/slides/details/:SubjectId", controller: "SlidesDetailsController"});
	this.route("slides.edit", {path: "/slides/edit/:SubjectId", controller: "SlidesEditController"});
	this.route("freezers", {path: "/freezers", controller: "FreezersController"});
	this.route("freezers.insert", {path: "/freezers/insert", controller: "FreezersInsertController"});
	this.route("freezers.details", {path: "/freezers/details/:id", controller: "FreezersDetailsController"});
	this.route("freezers.edit", {path: "/freezers/edit/:id", controller: "FreezersEditController"});
});
